...
-- ans - the difference between the primary and the foreign can be stated as the primary key is used to uniquely identify the tuples whereas the foreign key is a set of attributes used to match the values of different column.
